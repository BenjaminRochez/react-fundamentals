...
We first learned how styling works inside ReactJS, we then applied this to ReactJS components & used template literals to build styled component. We created a prop size to control the size without having to know the class definition.
