...
We learned how to create & render element using React & JSX. We also learned a bit more about JSX & his limitation & why we are using babel to be able to run our code.
We learned about how {...props} can be used to set default values for things like className,...
## Background
