...
We learned how to render an array with map & the importance for react to have a unique key prop for items to be able to recognize the right item in an array.
